...
class Base():
    ...
    def save_to_file(cls):
        ...
        file_path = ".db_{}.json".format(s_class)
        objs_json = {}
OAOAOAOA        for obj_id, obj in DATA[s_class].items():
OAOAOAOAOAOAOAOA            objs_json[obj_id] = obj.to_json(True)

        with open(file_path, 'w') as f:
OAOAOAOA            json.dump(objs_json, f)

OAOAOAOA    def save(self):
OAOAOAOA        """Save current object.
OAOAOAOA        """
...
OAOAOAOA        """
        s_class = cls.__name__
OAOAOAOA        return len(DATA[s_class].keys())
OAOAOAOA
OAOAOAOA    @classmethod
    def all(cls) -> Iterable[TypeVar('Base')]:
OAOAOAOA        """Return all objects.
OAOAOAOA        """
        return cls.search()
OAOAOAOA
    @classmethod
